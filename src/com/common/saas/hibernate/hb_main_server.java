package com.common.saas.hibernate;
...
public class hb_main_server implements iDisposable {
	...
	public hb_main_server()
	{
		try {
			this.hibernateSession = HibernateUtil.getSessionFactoryServer().openSession(); //Sesion de hibernate for Server
	...
	protected void finalize()
	{
		...
		try {
			if (this.hibernateSession!=null){
				...
				{
					this.hibernateSession.close(); //Close Session
	...
	public void controlOpen()
	{
		...
		try {
			if (this.hibernateSession==null){
				this.hibernateSession = HibernateUtil.getSessionFactoryServer().openSession();
			}
			else{
