...
/**
 * VinParamsRole generated by hbm2java
 */
@Entity
@Table(name = "vin_params_role", catalog = "movilidad")
public class VinParamsRole implements java.io.Serializable {

	private VinParamsRoleId id;
	private VinRoles vinRoles;
	private VinParamsGlobal vinParamsGlobal;
	private String value;
	private String comment;

	public VinParamsRole() {
	}

	public VinParamsRole(VinParamsRoleId id, VinRoles vinRoles,
	...
	public VinParamsRoleId getId() {
		return this.id;
	}

	public void setId(VinParamsRoleId id) {
		this.id = id;
	}
