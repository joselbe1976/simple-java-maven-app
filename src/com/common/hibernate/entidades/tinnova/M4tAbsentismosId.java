...
/**
 * M4tAbsentismosId generated by hbm2java
 */
@Embeddable
public class M4tAbsentismosId implements java.io.Serializable {
	...
	public M4tAbsentismosId() {
	}

	public M4tAbsentismosId(String idSociedad, String idEmpleado, Date fecAltaEmpleado, Date fecInicio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof M4tAbsentismosId))
			return false;
		M4tAbsentismosId castOther = (M4tAbsentismosId) other;
