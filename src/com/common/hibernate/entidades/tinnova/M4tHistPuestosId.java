...
/**
 * M4tHistPuestosId generated by hbm2java
 */
@Embeddable
public class M4tHistPuestosId implements java.io.Serializable {
	...
	public M4tHistPuestosId() {
	}

	public M4tHistPuestosId(String idSociedad, String idEmpleado, Date fecAltaEmpleado, Date fecInicio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof M4tHistPuestosId))
			return false;
		M4tHistPuestosId castOther = (M4tHistPuestosId) other;
