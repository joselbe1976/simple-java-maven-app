...
/**
 * M4tHistCentTrab generated by hbm2java
 */
@Entity
@Table(name = "M4T_HIST_CENT_TRAB", schema = "dbo", catalog = "EMIND")
public class M4tHistCentTrab implements java.io.Serializable {

	private M4tHistCentTrabId id;
	private M4tCentrosTrab m4tCentrosTrab;
	...
	public M4tHistCentTrab() {
	}

	public M4tHistCentTrab(M4tHistCentTrabId id, M4tCentrosTrab m4tCentrosTrab, M4tFasesAlta m4tFasesAlta,
			String idMotivoCambio) {
		this.id = id;
		this.m4tCentrosTrab = m4tCentrosTrab;
		this.m4tFasesAlta = m4tFasesAlta;
		this.idMotivoCambio = idMotivoCambio;
	}

	public M4tHistCentTrab(M4tHistCentTrabId id, M4tCentrosTrab m4tCentrosTrab, M4tFasesAlta m4tFasesAlta, Date fecFin,
	...
	public M4tHistCentTrabId getId() {
		return this.id;
	}

	public void setId(M4tHistCentTrabId id) {
		this.id = id;
	}

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "ID_CENTRO_TRABAJO", nullable = false)
	public M4tCentrosTrab getM4tCentrosTrab() {
		return this.m4tCentrosTrab;
	}

	public void setM4tCentrosTrab(M4tCentrosTrab m4tCentrosTrab) {
		this.m4tCentrosTrab = m4tCentrosTrab;
	}
