...
/**
 * M4tHistDepartamId generated by hbm2java
 */
@Embeddable
public class M4tHistDepartamId implements java.io.Serializable {
	...
	public M4tHistDepartamId() {
	}

	public M4tHistDepartamId(String idSociedad, String idEmpleado, Date fecAltaEmpleado, Date fecInicio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof M4tHistDepartamId))
			return false;
		M4tHistDepartamId castOther = (M4tHistDepartamId) other;
