...
/**
 * M4tHistCentTrabId generated by hbm2java
 */
@Embeddable
public class M4tHistCentTrabId implements java.io.Serializable {
	...
	public M4tHistCentTrabId() {
	}

	public M4tHistCentTrabId(String idSociedad, String idEmpleado, Date fecAltaEmpleado, Date fecInicio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof M4tHistCentTrabId))
			return false;
		M4tHistCentTrabId castOther = (M4tHistCentTrabId) other;
