...
String bloq="";
String nif="";
String id_empleado_rrhh="";
String fase_alta_rrhh="";
try{
	...
	nif = request.getParameter("nif")==null?"":request.getParameter("nif");
	id_empleado_rrhh = request.getParameter("id_empleado_rrhh")==null?"":request.getParameter("id_empleado_rrhh");
	fase_alta_rrhh = request.getParameter("fase_alta_rrhh")==null?"":request.getParameter("fase_alta_rrhh");
...
{
	new ParamsApp().systemDebugExt(ParamsApp.LOG_LEVEL_WEB,"Error usuarios_save.jsp:" + e.getStackTrace(),ParamsApp.LOG_TYPE_ERROR);
}
finally
{
...
try{
	...
	if (oper.equals("NEW"))  //registro nuevo
	{
		...
		usr.setNif(nif);
		usr.setIdEmpleadoRrhh(id_empleado_rrhh);
		usr.setFaseAltaRrhh(fase_alta_rrhh);
