...
try{
		...
		for (int i = 0; i< dataAux.size();i++)
		{
			 ...
			 obj.put("nif", tools.controlNulls(record.getNif()));
			 obj.put("id_empleado_rrhh", tools.controlNulls(record.getIdEmpleadoRrhh()));
			 obj.put("fase_alta_rrhh", tools.controlNulls(record.getFaseAltaRrhh()));
	...
	new ParamsApp().systemDebugExt(ParamsApp.LOG_LEVEL_WEB,"Error usuarios_data.jsp:" + e.getStackTrace(),ParamsApp.LOG_TYPE_ERROR);
	out.print("null");
}
finally
{
