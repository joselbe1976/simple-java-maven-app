...
<%@ page import="com.common.hibernate.classes.hb_params_role, com.common.hibernate.entidades.*" %>
...
hb_params_role data; //objeto clase
Boolean result = false;
String DevText="true{Datos grabados correctamente";

data = new hb_params_role();
VinParamsRole usr = new VinParamsRole();
...
try{
	...
	if (oper.equals("NEW"))  //registro nuevo
	{
		...
		VinParamsRoleId aux = new VinParamsRoleId();
		aux.setIdParam(Integer.parseInt(id_param));
		aux.setIdRole(Integer.parseInt(code));
		usr.setId(aux);
