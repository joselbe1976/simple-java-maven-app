...
<%@ page import="com.common.hibernate.classes.hb_params_process, com.common.hibernate.entidades.*" %>
...
hb_params_process data; //objeto clase
Boolean result = false;
String DevText="true{Datos grabados correctamente";

data = new hb_params_process();
VinParamsProcess usr = new VinParamsProcess();
...
try{
	...
	if (oper.equals("NEW"))  //registro nuevo
	{
		...
		VinParamsProcessId aux = new VinParamsProcessId();
		aux.setIdParam(Integer.parseInt(id_param));
		aux.setIdProcess(code);
		usr.setId(aux);
