...
<%@ page import="com.common.hibernate.classes.hb_params_role" %>
...
try{
		...
		{
			VinParamsRoleView  record = (VinParamsRoleView)dataAux.get(i); //capturamos la entidad Usamos vista 
