...
<%@ page import="com.common.hibernate.classes.hb_params_device" %>
...
try{
		...
		{
			VinParamsDeviceView  record = (VinParamsDeviceView)dataAux.get(i); //capturamos la entidad Usamos vista 
			 ...
			 //asignamos datos
			 obj.put("id",record.getId().getIdDevice());	
