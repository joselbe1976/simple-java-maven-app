...
<%@ page import="com.common.hibernate.classes.hb_params_system, com.common.hibernate.entidades.*" %>
...
hb_params_system data; //objeto clase
Boolean result = false;
String DevText="true{Datos grabados correctamente";

data = new hb_params_system();
VinParamsSystem usr = new VinParamsSystem();
...
try{
	...
	if (oper.equals("NEW"))  //registro nuevo
	{
		...
		VinParamsSystemId aux = new VinParamsSystemId();
		aux.setIdParam(Integer.parseInt(id_param));
		aux.setIdSystem(code);
		usr.setId(aux);
