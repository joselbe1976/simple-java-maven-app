...
<%@ page import="com.common.hibernate.classes.hb_params_users, com.common.hibernate.entidades.*" %>
...
hb_params_users data; //objeto clase
Boolean result = false;
String DevText="true{Datos grabados correctamente";

data = new hb_params_users();
VinParamsUser usr = new VinParamsUser();
...
try{
	...
	if (oper.equals("NEW"))  //registro nuevo
	{
		...
		VinParamsUserId aux = new VinParamsUserId();
