...
<%@ page import="com.common.hibernate.classes.hb_params_system" %>
...
try{
		...
		{
			VinParamsSystemView  record = (VinParamsSystemView)dataAux.get(i); //capturamos la entidad Usamos vista 
			 ...
			 //asignamos datos
			 obj.put("id",record.getId().getIdSystem());	
