...
<%@ page import="com.common.hibernate.classes.hb_params_users" %>
...
try{
		...
		{
			VinParamsUserView  record = (VinParamsUserView)dataAux.get(i); //capturamos la entidad Usamos vista 
			 ...
			 //asignamos datos
			 obj.put("id",record.getId().getIdUser());	
